...
int main()
{
	...
	String s3 = s2; // Das ist ein Kopierkonstruktor: String s3(s2)
	...
	char* pStr = new char[s4.getLength() + 1]; // Platz fur den string mit '\0'
	s4.getStr(pStr);
	cout << pStr << endl;	// cout kennt char*
	delete[] pStr;			// Dynamische speicher auflösen
